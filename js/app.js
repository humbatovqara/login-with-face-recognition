...
video.addEventListener("play", async () => {
    ...
    let cameraInterval = setInterval(async () => {
        ...
        if (
            results.length > 0 && ["Qara", "Nurlan"].indexOf(results[0].label) > -1
        ) {
            faceIDResult.textContent = "FaceID təsdiqləndi. Digər səhifəyə keçid edilir...";
            ...
            faceIDResult.textContent = "FaceID təsdiqlənmədi...";
            faceIDResult.classList = [];
